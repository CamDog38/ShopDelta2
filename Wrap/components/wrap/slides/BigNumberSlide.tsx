  ...
  return (
    <div className="relative flex min-h-full w-full flex-col items-center justify-center px-6 sm:px-16 py-12">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 text-center">
        {label && (
          <motion.div
            className="text-[10px] sm:text-xs uppercase tracking-[0.24em] text-slate-200/70"
        ...
        <motion.div
          className="text-4xl sm:text-6xl font-bold tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.7)]"
        ...
        {slide.subtitle && (
          <motion.p
            className="max-w-md text-xs sm:text-sm text-slate-200/80"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
